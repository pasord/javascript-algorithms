import BinarySearchTree from './binarySerachTree.js';
// ---------------- 封装的树结构测试 ---------------- //
...
console.log('search(98)-迭代实现', binarySearchTree.search(98));
console.log('search(10)-迭代实现', binarySearchTree.search(10));
